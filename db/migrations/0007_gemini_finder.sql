...
CREATE TABLE IF NOT EXISTS opportunity_finder_assessments (
  ...
  finder_result_id TEXT NOT NULL UNIQUE,
  assessment_json TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_finder_ai_usage_workspace_month
ON finder_ai_usage(workspace_id, month, status);

CREATE INDEX IF NOT EXISTS idx_opportunity_finder_assessments_opportunity
ON opportunity_finder_assessments(workspace_id, opportunity_id);
