...
export type StoredTask={uid:string;id:number;version:number;title:string;lead:string;leadId?:string;companyId?:string;contactId?:string;opportunityId?:string;owner:string;priority:string;due:string;dueAt?:string;time:string;type:string;notes:string;status:string;reminder?:string;recurrence?:string;outcome?:string};
